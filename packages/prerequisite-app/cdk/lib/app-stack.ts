...
export type PrerequisiteExampleStackProps = EnforcedStackProps;

export class PrerequisiteExampleStack extends EnforcedStack {

  constructor(scope: Construct, id: string, props: PrerequisiteExampleStackProps) {
